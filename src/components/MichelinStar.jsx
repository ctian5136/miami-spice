...
// The official Michelin Guide star mark, provided by the user.
export default function MichelinStar({ size = 14 }) {
  return (
    <svg width={size} height={size * (1000 / 916)} viewBox="0 -150 916 1000">
      <path
        fill="#D3072B"
        d="M624 69v-49q0 -74 -47 -122t-119 -48q-78 0 -122 49t-44 131v15q0 4 1 7l1 17q-74 -53 -133 -53q-46 0 -88 31q-40 29 -59 76q-14 33 -14 66q0 101 116 154l15 7q-131 60 -131 162q0 69 48 121t114 52q60 0 119 -43l13 -10q-2 20 -2 48q0 75 47 122.5t119 47.5
